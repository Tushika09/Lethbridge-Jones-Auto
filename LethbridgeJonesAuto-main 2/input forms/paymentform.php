<!-- INSTRUCTIONS:
1. Find existing sale ID
    Won't work if payment not for existing sale
2. Find NEXT unused payment number for chosen sale ID
3. Enter payment number, sale id, due date, payment date, amount due, amount paid, and bank account -->
...
<!-- <p align="center"><b>New Customer</b></p> -->
